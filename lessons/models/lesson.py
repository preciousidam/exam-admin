...
class Lesson(models.Model):
    ...
    subject = models.ForeignKey(Subject, verbose_name=_("Subject"), null=True, on_delete=models.SET_NULL, related_name="lessons")
    topic = models.ForeignKey(Topic, verbose_name=_("Topic"), null=True, on_delete=models.SET_NULL, related_name="lessons")
